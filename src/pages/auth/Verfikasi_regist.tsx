      ...
      <div className="relative w-full max-w-sm flex flex-col items-center">
        ...
        {showSuccessPopup && (
          <MyPopup
            ...
            message='Akun Anda telah terdaftar. Silahkan Masuk kembali!'
            variant='success'
        ...
        <MyForm title="" className="w-full space-y-3 px-5">
          ...
          <div className="flex justify-end text-white text-xs mb-10">
            <span>
             <span>&larr;</span>
              <Link to="/register" className="pl-1">Kembali</Link>
            </span>
          </div>
          <MyButton
            text={'Verifikasi'}
...
export default Verifikasi_regist